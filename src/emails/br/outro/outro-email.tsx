...
import type { OutroEmailProps } from './schema';

export function OutroEmail({ verificationCode }: OutroEmailProps) {
  return (
    <Html>
      <Head />
        ...
        <Container style={container}>
          <Section style={coverSection}>
            <Section style={imageSection}>
              <Img
                src={`https://react-email-demo-9fn3mchcm-resend.vercel.app/static/aws-logo.png`}
                width="75"
                height="45"
                alt="AWS's Logo"
              />
